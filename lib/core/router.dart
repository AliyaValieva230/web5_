...
import '../screens/reader_dashboard_screen.dart';
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (_, __) => const ReaderDashboardScreen(),
      ),
      GoRoute(
        path: '/librarian',
        redirect: (_, __) => auth.user?.role == Role.librarian ? null : '/forbidden',
        builder: (_, __) => const LibrarianDashboardScreen(),
      ),
      GoRoute(
        path: '/admin',
      ...
      GoRoute(
        path: '/books/:id/edit',
        redirect: (_, __) => auth.has(Role.librarian) ? null : '/forbidden',
        builder: (_, s) => BookFormScreen(id: int.tryParse(s.pathParameters['id']!)),
      ),
      GoRoute(
        path: '/books/:id',
        builder: (_, s) => BookDetailScreen(id: int.tryParse(s.pathParameters['id']!)!),
      ),
      ...
      GoRoute(
        ...
        redirect: (_, __) => auth.has(Role.librarian) ? null : '/forbidden',
        builder: (_, s) => AuthorFormScreen(id: int.tryParse(s.pathParameters['id']!)),
      ),
      GoRoute(
        path: '/authors/:id',
        builder: (_, s) => AuthorDetailScreen(id: int.tryParse(s.pathParameters['id']!)!),
      ),
      ...
      GoRoute(
        path: '/genres/:id/edit',
        redirect: (_, __) => auth.has(Role.librarian) ? null : '/forbidden',
        builder: (_, s) => GenreFormScreen(id: int.tryParse(s.pathParameters['id']!)),
      ),
      ...
      GoRoute(
        ...
        redirect: (_, __) => auth.has(Role.librarian) ? null : '/forbidden',
        builder: (_, s) => PublisherFormScreen(id: int.tryParse(s.pathParameters['id']!)),
      ),
      ...
      GoRoute(
        ...
        redirect: (_, __) => auth.has(Role.librarian) ? null : '/forbidden',
        builder: (_, s) => ReaderFormScreen(id: int.tryParse(s.pathParameters['id']!)),
      ),
      GoRoute(
        path: '/readers/:id',
        builder: (_, s) => ReaderDetailScreen(id: int.tryParse(s.pathParameters['id']!)!),
      ),
    ],
