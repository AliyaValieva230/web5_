...
final List<Author> seedAuthors = [
  ...
  Author(id: 4, firstName: 'Джоан', lastName: 'Роулинг', country: 'Великобритания'),
  Author(id: 5, firstName: 'Эрих Мария', lastName: 'Ремарк', country: 'Германия'),
  Author(id: 6, firstName: 'Джордж', lastName: 'Оруэлл', country: 'Великобритания'),
...
class PersistentAuthorRepository implements AuthorRepository {
  ...
  PersistentAuthorRepository(this._prefs) { _restore(); }
  ...
  Future<PageResult<Author>> find({
    ...
    rows.sort((a, b) {
      ...
      switch (sortField) {
        ...
        case 'country': r = a.country.compareTo(b.country); break;
  ...
  Future<Author?> findById(int id) async {
    try { return _authors.firstWhere((a) => a.id == id); } catch (_) { return null; }
  }
