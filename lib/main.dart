  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (_) => BookListNotifier(bookRepo)..load()),
        ChangeNotifierProvider(create: (_) => AuthorListNotifier(authorRepo)..load()),
        ChangeNotifierProvider(create: (_) => GenreListNotifier(genreRepo)..load()),
        ChangeNotifierProvider(create: (_) => PublisherListNotifier(publisherRepo, bookRepo)..load()),
        ChangeNotifierProvider(create: (_) => ReaderListNotifier(readerRepo)..load()),
      ],
